...
app.get("/api/top-countries", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// Submit the new vote
app.post("/api/submit-vote", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post("/api/checks-email", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
